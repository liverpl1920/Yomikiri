...
ActiveRecord::Schema[7.2].define(version: 2026_08_01_234711) do
  ...
  create_table "reading_logs", force: :cascade do |t|
    ...
    t.integer "end_page"
    t.index ["book_id", "read_at"], name: "index_reading_logs_on_book_id_and_read_at"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "yearly_goal", default: 50, null: false
